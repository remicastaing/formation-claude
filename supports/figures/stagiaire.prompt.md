# Illustration `stagiaire.png`

Slide 3.1, placement : option A, colonne gauche. Copier le bloc ci-dessous tel quel dans ChatGPT, enregistrer le résultat sous `supports/figures/stagiaire.png`.
...
SCÈNE
Le nouveau collègue, à gauche, tend vers la droite une pile de dossiers vacillante, haute comme lui, à un stagiaire encore plus jeune et plus dégingandé, casquette de travers, qui la reçoit les bras tendus et les genoux fléchis. Le collègue tient déjà, de l'autre main, une unique feuille bien nette qu'il regarde avec satisfaction. En orange : cette feuille unique.
```
