# Illustration `description-etiquette.png`

Slide 2.3, placement : option B, colonne droite. Copier le bloc ci-dessous tel quel dans ChatGPT, enregistrer le résultat sous `supports/figures/description-etiquette.png`.
...
SCÈNE
Le nouveau collègue, à droite, le nez collé sur une rangée de classeurs vus de tranche, tous porteurs d'une étiquette vierge ou illisible, sauf un dont l'étiquette est nette. Il pointe celui-là du doigt avec un sourire de soulagement, le corps penché vers la gauche. Une petite lampe de bureau éclaire la scène. En orange : l'étiquette nette.
```
