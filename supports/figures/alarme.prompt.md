# Illustration `alarme.png`

Slide 5.1, placement : option A, colonne gauche. Copier le bloc ci-dessous tel quel dans ChatGPT, enregistrer le résultat sous `supports/figures/alarme.png`.
...
SCÈNE
Le nouveau collègue, à gauche, s'apprête à pousser une porte marquée d'un pictogramme d'interdiction, un dossier sous le bras, l'air innocent. Un tourniquet de sécurité massif lui barre le passage, et une petite lampe au-dessus de la porte clignote avec des lignes cinétiques ; il est arrêté net, un pied en l'air, les cheveux dressés par la surprise. Personne d'autre dans la scène : c'est le bâtiment qui dit non. En orange : la lampe qui clignote.
```
