# Illustration `grille.png`

Slide 9.1, placement : option A, colonne gauche. Copier le bloc ci-dessous tel quel dans ChatGPT, enregistrer le résultat sous `supports/figures/grille.png`.
...
SCÈNE
Fin de journée. Le nouveau collègue, à gauche, sort par la même porte que le matin, mais dans l'autre sens, vers la droite, l'air fatigué et content, cheveux encore plus en bataille. Il ne porte plus de carton : une seule feuille pliée dépasse de sa poche de chemise. Derrière lui, sur le mur, un tableau blanc couvert de traits abstraits et d'un grand cercle fléché. En orange : la feuille dans la poche.
```
