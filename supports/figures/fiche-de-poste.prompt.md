# Illustration `fiche-de-poste.png`

Slide 1.1, placement : option B, colonne droite. Copier le bloc ci-dessous tel quel dans ChatGPT, enregistrer le résultat sous `supports/figures/fiche-de-poste.png`.
...
SCÈNE
Une responsable, debout à droite devant une armoire qui déborde de classeurs, tend vers la gauche une feuille unique au nouveau collègue, qui s'avance pour la prendre, ravi. Elle ne lui donne pas les classeurs. En orange : la feuille.
```
