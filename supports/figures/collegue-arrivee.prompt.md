# Illustration `collegue-arrivee.png`

Slide 0.3, placement : option A, colonne gauche. Copier le bloc ci-dessous tel quel dans ChatGPT, enregistrer le résultat sous `supports/figures/collegue-arrivee.png`.
...
SCÈNE
Le nouveau collègue franchit une porte située à gauche et entre vers la droite, un carton sous le bras contenant une plante et quelques classeurs, badge de travers, sourire enthousiaste, grandes enjambées. Pas d'open space derrière lui : au plus un coin de bureau et une chaise suggérés à droite. En orange : le badge.
```
