# Illustration `acces.png`

Slide 4.1, placement : option B, colonne droite. Copier le bloc ci-dessous tel quel dans ChatGPT, enregistrer le résultat sous `supports/figures/acces.png`.
...
SCÈNE
Le nouveau collègue, à droite, reçoit des mains d'un agent de sécurité impassible, casquette et moustache, un énorme trousseau : badges, clés, cartes magnétiques, qui pend jusqu'au sol et tinte. Il le tient à deux mains vers la gauche, ébahi. Derrière eux, trois portes fermées vues de biais, chacune avec un petit lecteur de badge. En orange : un seul badge du trousseau, celui qu'il regarde.
```
