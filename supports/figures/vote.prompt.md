# Illustration `vote.png`

Slide 8.1, placement : option B, colonne droite. Copier le bloc ci-dessous tel quel dans ChatGPT, enregistrer le résultat sous `supports/figures/vote.png`.
...
SCÈNE
Le nouveau collègue, à droite, debout sur une chaise de bureau à roulettes qui vacille, présente fièrement vers la gauche une unique feuille de réponse tenue à bout de bras, comme un trophée. À ses pieds, la chaise roule légèrement, lignes cinétiques. Face à lui, hors champ à gauche, on devine juste deux ou trois mains levées qui entrent dans l'image. En orange : la feuille.
```
