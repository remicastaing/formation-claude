# Quel signal, quel mécanisme {.unnumbered}
...
**Pour vérifier** : `/context`, `/skills`, `/mcp`, `/hooks`, `/skill-doctor`.
...
- Plugins : <https://code.claude.com/docs/en/plugins>, <https://code.claude.com/docs/en/discover-plugins>
